...
export default function ChallengerPlayerCard({
  ...
  return (
    <div
      className={`relative w-full h-[100px] mb-4 group transition-all duration-300 ${isPending ? "opacity-50" : "cursor-pointer"}`}
    >
      <div
      ...
      <div className="absolute left-[200px] top-1/2 transform -translate-y-1/2 z-10">
        ...
        {isPending && (
          <p className="text-yellow-400 text-xs orbitron">Request Sent...</p>
        )}
      </div>
