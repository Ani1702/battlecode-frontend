      ...
      <div className="h-full z-1 bg-[radial-gradient(50%_50%_at_50%_50%,rgba(0,0,0,0.17)_0%,rgba(0,0,0,0.57)_100%)]">
        <div className="hud">
          <div className="absolute topHUD left-0 top-2 h-[6rem] w-full flex items-center justify-center">
            <div className="h-full w-full bg-[url(/TopBar.svg)] bg-no-repeat bg-center flex flex-col items-center justify-center space-y-6 tracking-wider font-orbitron">
              IEEE COMPUTER SOCIETY
            </div>
            <div className="h-full w-full bg-[url(/TopBar.svg)] bg-no-repeat bg-center flex flex-col items-center justify-center space-y-6 absolute blur-md tracking-wider font-orbitron">
              IEEE COMPUTER SOCIETY
            </div>
            <div className="h-full w-full bg-no-repeat bg-center flex flex-col items-center justify-center space-y-6 absolute blur-md tracking-wider font-orbitron">
              IEEE COMPUTER SOCIETY
            </div>
          </div>
        ...
        <div className="w-[27rem] quote flex relative bottom-8 z-10 left-1/2 transform -translate-x-1/2 justify-center">
          <p className="z-1 text-center uppercase tracking-[4px] absolute bottom-[5rem] text-[0.85rem] font-orbitron">
            This is more than just programming—it's precision under pressure.
            Enter the match with intent. Exit with impact.
          </p>
          <p className="text-center uppercase tracking-[4px] absolute bottom-[5rem] blur-md text-[0.85rem] font-orbitron">
            This is more than just programming—it's precision under pressure.
            Enter the match with intent. Exit with impact.
          </p>
        </div>
