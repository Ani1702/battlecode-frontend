  ...
  return (
    <div className={`bg-[url(/Landingpage.svg)] bg-cover h-screen transform transition-transform duration-1000 overflow-x-hidden overflow-y-hidden ease-out ${
      ...
      <div className="h-full z-1 orbitron bg-[radial-gradient(50%_50%_at_50%_50%,rgba(0,0,0,0.17)_0%,rgba(0,0,0,0.57)_100%)]">
        ...
        <div className = "sm:hidden justify-center flex relative bottom-42 lg:bottom-8 z-10 left-1/2 transform -translate-x-1/2 text-center text-white text-sm lg:text-md font-medium ">
