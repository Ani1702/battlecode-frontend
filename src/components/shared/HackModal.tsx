...
export default function HackModal({
  ...
  const handlePrev = () => {
    setCurrentIndex(
      (prev) => (prev - 1 + submissions.length) % submissions.length,
    );
  };
      ...
      <div className="relative flex flex-col w-full max-w-4xl h-[90vh] bg-gray-900 border-2 border-red-500 rounded-lg text-white oxanium">
        ...
        <div className="flex items-center justify-between p-4 border-b border-red-500/30">
          <h2 className="text-2xl font-bold flex items-center gap-3">
            <Swords className="text-red-400" /> Hacking Arena
          </h2>
          {submissions.length > 0 && (
            <div className="flex items-center gap-4 mr-10">
              <button
                ...
                className="p-2 rounded-md hover:bg-gray-700 disabled:opacity-40"
              >
                <ChevronLeft />
              </button>
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-4 p-4 min-h-0">
          {submissions.length > 0 && currentSubmission ? (
            <>
              ...
              <div className="w-full lg:w-1/3 flex flex-col gap-4">
                ...
                <p className="text-sm text-gray-400">
                  Provide an input test case that you believe will cause this
                  solution to fail.
                </p>
                <textarea
            ...
            <div className="w-full flex items-center justify-center text-gray-400">
              <p>
                No other submissions are available to hack for this problem.
              </p>
            </div>
          )}
        </div>
