...
export default function R1CodePage() {
  ...
  const getPopupContent = (type: 'win' | 'lose' | 'timeout' | 'admin_end') => {
    switch (type) {
      ...
      case 'admin_end': return { title: "🛑 Round Ended", message: 'The admin has ended Round 1. You will be redirected to the dashboard.', className: 'text-orange-400', buttonText: 'Return to Dashboard' };
    }
  };
