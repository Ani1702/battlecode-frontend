          ...
          <div className="h-full">
            <div className="flex-1 ml-3 orbitron flex justify-between items-start h-full px-2 pt-2">
              ...
              <div className="flex items-center  mr-20 mt-1">
                <span className="text-[20px] text-white/80 font-medium tracking-tight">IEEECS&nbsp; &nbsp;X</span>
                <svg viewBox="0 0 710.482 194.87" xmlns="http://www.w3.org/2000/svg" fill="currentColor" style={{ width: '120px', height: '24px', color: '#F97316' }}>
